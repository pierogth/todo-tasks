...
var E = N;
function w({ children: l, initialPage: c, initialComponent: s, resolveComponent: p, titleCallback: a, onHeadUpdate: S }) {
...
async function j({ id: l = "app", resolve: c, setup: s, title: p, progress: a = {}, page: S, render: d }) {
  let P = typeof window > "u", u = P ? null : document.getElementById(l), g = S || JSON.parse(u.dataset.page), f = (r) => Promise.resolve(c(r)).then((y) => y.default || y), e = [], i = await f(g.component).then((r) => s({ el: u, App: w, props: { initialPage: g, initialComponent: r, resolveComponent: f, titleCallback: p, onHeadUpdate: P ? (y) => e = y : null } }));
  if (!P && a && Z(a), P) {
...
<Link href="${p}" method="${a}" as="button">...</Link>`), (0, import_react6.createElement)(c, { ...O, ...c === "a" ? { href: p } : {}, ref: R, onClick: I }, l);
});
...
function W(l, c) {
  ...
  let v = (0, import_react7.useCallback)((t, o, n = {}) => {
    ...
    t === "delete" ? Oe.delete(o, { ...k2, data: I(u) }) : Oe[t](o, I(u), k2);
  }, [u, e]);
  return { data: u, setData(t, o) {
    g(typeof t == "string" ? { ...u, [t]: o } : typeof t == "function" ? (n) => t(n) : t);
  }, isDirty: !(0, import_lodash.default)(u, a), errors: f, hasErrors: i, processing: y, progress: H, wasSuccessful: M, recentlySuccessful: O, transform(t) {
    I = t;
  }, setDefaults(t, o) {
